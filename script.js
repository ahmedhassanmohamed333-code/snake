...
const syllabus = [
    {
        chapter: "الباب الأول: الحيوانات الأليفة",
        branches: [
            {
                title: "1. القطة والكلب",
                lesson: "💡 تذكر: القطة تحب شرب الحليب، والكلب يحرس المنزل.",
                questions: [
                    { q: "ماذا تحب القطة أن تشرب؟", options: ["العصير", "الحليب", "الماء"], a: "الحليب" },
                    { q: "من الذي يحرس المنزل؟", options: ["الكلب", "العصفور", "الأرنب"], a: "الكلب" }
                ]
            },
            {
                title: "2. حيوانات المزرعة",
                lesson: "💡 تذكر: البقرة تعطينا الحليب، والدجاجة تعطينا البيض.",
                questions: [
                    { q: "من أين نحصل على البيض؟", options: ["البقرة", "الدجاجة", "الحصان"], a: "الدجاجة" },
                    { q: "ماذا تعطينا البقرة؟", options: ["البيض", "الحليب", "العسل"], a: "الحليب" }
                ]
            }
        ]
    }
    // يمكنك إضافة { chapter: "الباب الثاني...", branches: [ ... ] } هنا
];
